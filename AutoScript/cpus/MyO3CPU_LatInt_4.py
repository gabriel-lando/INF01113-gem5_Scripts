...
class MyIntMultDiv(FUDesc):
    opList = [ OpDesc(opClass='IntMult', opLat=12, pipelined=True),
               OpDesc(opClass='IntDiv', opLat=64, pipelined=False) ]
...
class My_SIMD_Unit(FUDesc):
    opList = [ OpDesc(opClass='SimdAdd',          opLat=8),
               OpDesc(opClass='SimdAddAcc',       opLat=8),
               OpDesc(opClass='SimdAlu',          opLat=8),
               OpDesc(opClass='SimdCmp',          opLat=8),
               OpDesc(opClass='SimdCvt',          opLat=8),
               OpDesc(opClass='SimdMisc',         opLat=8),
               OpDesc(opClass='SimdMult',         opLat=8),
               OpDesc(opClass='SimdMultAcc',      opLat=8),
               OpDesc(opClass='SimdShift',        opLat=8),
               OpDesc(opClass='SimdShiftAcc',     opLat=8),
               OpDesc(opClass='SimdSqrt',         opLat=8),
               OpDesc(opClass='SimdFloatAdd',     opLat=8),
               OpDesc(opClass='SimdFloatAlu',     opLat=8),
               OpDesc(opClass='SimdFloatCmp',     opLat=8),
               OpDesc(opClass='SimdFloatCvt',     opLat=8),
               OpDesc(opClass='SimdFloatDiv',     opLat=8),
               OpDesc(opClass='SimdFloatMisc',    opLat=8),
               OpDesc(opClass='SimdFloatMult',    opLat=8),
               OpDesc(opClass='SimdFloatMultAcc', opLat=8),
               OpDesc(opClass='SimdFloatSqrt',    opLat=8) ]
    count = 1
