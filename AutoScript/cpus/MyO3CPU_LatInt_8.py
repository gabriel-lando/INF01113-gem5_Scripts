...
class MyIntALU(FUDesc):
    opList = [ OpDesc(opClass='IntAlu', opLat=8) ]
    count = 2

class MyIntMultDiv(FUDesc):
    opList = [ OpDesc(opClass='IntMult', opLat=24, pipelined=True),
               OpDesc(opClass='IntDiv', opLat=128, pipelined=False) ]
...
class My_SIMD_Unit(FUDesc):
    opList = [ OpDesc(opClass='SimdAdd',          opLat=16),
               OpDesc(opClass='SimdAddAcc',       opLat=16),
               OpDesc(opClass='SimdAlu',          opLat=16),
               OpDesc(opClass='SimdCmp',          opLat=16),
               OpDesc(opClass='SimdCvt',          opLat=16),
               OpDesc(opClass='SimdMisc',         opLat=16),
               OpDesc(opClass='SimdMult',         opLat=16),
               OpDesc(opClass='SimdMultAcc',      opLat=16),
               OpDesc(opClass='SimdShift',        opLat=16),
               OpDesc(opClass='SimdShiftAcc',     opLat=16),
               OpDesc(opClass='SimdSqrt',         opLat=16),
               OpDesc(opClass='SimdFloatAdd',     opLat=16),
               OpDesc(opClass='SimdFloatAlu',     opLat=16),
               OpDesc(opClass='SimdFloatCmp',     opLat=16),
               OpDesc(opClass='SimdFloatCvt',     opLat=16),
               OpDesc(opClass='SimdFloatDiv',     opLat=16),
               OpDesc(opClass='SimdFloatMisc',    opLat=16),
               OpDesc(opClass='SimdFloatMult',    opLat=16),
               OpDesc(opClass='SimdFloatMultAcc', opLat=16),
